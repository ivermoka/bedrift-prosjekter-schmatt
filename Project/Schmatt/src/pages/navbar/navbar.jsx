    ...
    <>
      <nav className=" flex flex-row w-screen h-14 z-20 bg-rich-black absolute  backdrop-blur-sm">
        <div id="left" className=" flex w-3/5 items-center">
          ...
          <a href="/chat" className="text-xl text-gray-50 group transition-all duration-300 ease-in-out"><span className="bg-left-bottom bg-gradient-to-r from-black to-white bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">Forums</span></a>
        </div>
        <div
          id="right"
